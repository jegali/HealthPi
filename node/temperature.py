...
# if this script is run on the local machine (aka the log and dashboard server),
# use address="/dev/log" instead
handler = logging.handlers.SysLogHandler(address=('192.168.178.29',514))


myLog.addHandler(handler)

#myLog.info("TemperaturWerte:\n")

temps = psutil.sensors_temperatures()
#if not temps:
#    sys.exit("can't read temperatures")
